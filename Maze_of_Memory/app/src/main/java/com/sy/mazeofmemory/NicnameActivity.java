...
public class NicnameActivity extends Activity {
        ...
        btn.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                //if (isNicname == true) {
                    ...
                    Intent intent = new Intent(NicnameActivity.this, MainActivity.class);
    ...
    private void HttpPostData() {
        ...
        try {
            ...
            Toast.makeText(NicnameActivity.this, "전송 후 결과 받음", Toast.LENGTH_LONG).show();
